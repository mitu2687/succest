<form role="search" method="get" id="searchform" class="searchform  form-inline" action="<?php echo home_url( '/' ); ?>">
    <div class="form-group col-md-8" style="margin-bottom: 15px;">
        ...
        <button class="btn btn-primary <?php print $b_block;?>" type="submit" id="searchsubmit" ><?php _e('Search','bonestheme'); ?></button>
    </div>
</form>